						...
						<form class="navbar-form navbar-left" id="searchForm"
							...
							<label class="">订单号</label> <input type="text"
								...
								<label class="">收货人</label> <input type="text"
									value="${parameter.entity.addressClone.consignee}" name="entity.addressClone.consignee" id="consignee"
							...
							<c:set var="amounts" value="0"/>
								<c:forEach items="${orders}" var="g">
									...
									>
										...
										<td><c:if test="${user.admin&&user.loginName ne 'zmz365zmz'}">
												<c:choose>
											...
											href="<c:url value='/pm/order/editOrderDeliverInfo.html?id=${g.id}' /> ">
											<span class="glyphicon glyphicon-wrench fa-fw" aria-hidden="true">
											</span>修改物流</a>
													</c:when>
												</c:choose>
											</c:if></td>
	...
	<script type="text/javascript">
		$(function() {
            ...
            $("#downNew").click(function (e) {
                ...
                e.preventDefault();
                var limit = $("#limit").val();
                var url = "<c:url value='/pm/order/getOrders.html'/>"+"?limit="+limit;
//                console.log(url);
