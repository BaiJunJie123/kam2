...
public class OrderQueryController {
	//跳转--“商城订单-发货管理”修改物流页面
	@RequestMapping(value = "/editOrderDeliverInfo.html", method = RequestMethod.GET)
	public String editOrderDeliverInfo(@ModelAttribute("parameter") SearchParameter<DeliveryNote> param,
		...
		return "pmall/order/updateDeliver";
	}
