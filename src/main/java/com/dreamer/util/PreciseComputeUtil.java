...
public class PreciseComputeUtil {
     ...
     * @return 四舍五入的结果
     */
    public static Double round(Double result_value){
        return Math.round(result_value*100)/100.0;
    }
     ...
     * 判断是否是金额数字
     */
    public static boolean isMoneyAmount(Double amount) {
    ...
    public static void main(String[] args) {
        System.out.println(PreciseComputeUtil.isMoneyAmount(0.01));
    }
}
